...
export default function AdminShell({
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
      {/* --- HEADER MOBILE (Visible uniquement < 768px) --- */}
      <header className="sticky top-0 z-50 flex h-16 w-full items-center justify-between border-b border-white/10 bg-black/90 px-4 backdrop-blur-md md:hidden">
        ...
        <button
          ...
          className="rounded-lg border border-white/10 bg-zinc-900 p-2 text-gray-300 hover:bg-zinc-800"
      ...
      <div className="mx-auto flex max-w-7xl">
        ...
        {/* --- BARRE LATÉRALE (Desktop Fixe + Mobile Drawer) --- */}
        <aside
          className={`fixed inset-y-0 left-0 z-50 flex w-64 flex-col justify-between border-r border-white/10 bg-black px-4 py-6 transition-transform duration-300 md:sticky md:top-0 md:h-screen md:translate-x-0 overflow-y-auto ${
        ...
        >
          <div className="space-y-6">
            ...
            {/* Navigation (Ferme le menu au clic sur mobile) */}
